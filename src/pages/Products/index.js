        ...
        <div className="w-full h-fit bg-white mt-16 font-light leading-4 px-[1.5rem] space-y-10">
            ...
            <div className="w-full flex justify-between h-fit items-center">
                ...
                <div className="flex space-x-2 items-center">
                    ...
                    <select id="filterFactor" className="px-[20px] py-[5px] bg-white border border-gray-400">
            ...
            <div className="flex flex-col w-full ">
                ...
                <button className="fifth flex self-center justify-center w-[250px] border text-gray-700  py-2 my-12 text-sm leading-4 font-thin">
                    See More
                </button>
            </div>
            <img
