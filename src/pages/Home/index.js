    ...
    return (
        <div className='w-full min-h-min'>
            ...
            <div className='flex flex-col w-full '>
                <div className='py-5 my-6 text-center text-2xl leading-7 font-semibold'>
                    NEW ARRIVAL
                </div>
            ...
            <div className='w-full h-fit'>
                <div className='py-5 my-6 text-center text-xl leading-7 font-semibold'>
                    NEW COLLECTIONS
                </div>
                <div className='flex justify-around'>
                    <div
                        ...
                        style={{
                            backgroundImage:
                                'url("https://levents.asia/wp-content/uploads/2022/12/Desktop-3-100.jpg")',
                        }}>
