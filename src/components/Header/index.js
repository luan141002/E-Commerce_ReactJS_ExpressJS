...
const Header = () => {
    ...
    const subNavBar = [
        { colName: 'Home', link: '/homepage' },
        { colName: 'Custom your own cloth', link: '/products' },
        { colName: 'Log out', link: '/' },
    ];
    ...
    const [openMenus, setOpenMenus] = useState([false, false, false, false, false, false, false, false]);
    ...
    return (
        <div id="container" className="w-full fixed bg-white z-20 h-[90px]  ">
                    ...
                    <div className="flex flex-col w-[40%] box-border">
                        <div className="flex space-x-3 px-[3px]">
                            {/* {collections.map((collection, index) => (
                                <label key={index} className="font-bold text-gray-500 text-xs">
                                    {collection}
                                </label>
                            ))} */}
                        </div>
            ...
            </div>
            {
                ...
                >
                    <ul className="flex justify-around bg-white border-gray-400 ">
                            ...
                            if (!Topic.subCol) {
                                return (
                                    <li
                                        ...
                                        onClick={() => {
                                            if (Topic.colName === 'Log out') {
                                                AuthService.logout();
                                            }
                                        }}
                                        className="font-light w-[12%]  text-center"
                                    >
                                        <Link to={Topic.link}>{Topic.colName}</Link>
                                    </li>
                                );
                            } else {
                                return (
